...
- `dependency-audit_safe.os` — the correct design.
- `dependency-audit_unsafe.os` — the tempting-but-wrong version (the negative example a model must learn to reject).
