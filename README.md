...
- `dependency-audit_safe.eide` — the correct design.
- `dependency-audit_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
